...
Basierend auf dem vorliegenden Qt-Programmgerüst ysoll ein einfacher Webclient programmiert werden. 
...
4. Kopiere den Fork auf deinen Raspberry: `git clone git@github.com:<dein Accountname>/Webclient.git` In dem dadurch
   erzeugten Ordner befindet sich das Projekt. 
